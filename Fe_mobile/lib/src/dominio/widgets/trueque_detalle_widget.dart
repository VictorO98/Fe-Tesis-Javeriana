...
class TruequeDetalleWidget extends StatefulWidget {
  List<InfoTruequesModel>? infoTrueques;

  @override
  _TruequeDetalleWidgetState createState() => _TruequeDetalleWidgetState();

  TruequeDetalleWidget({Key? key, this.infoTrueques}) : super(key: key);
}

class _TruequeDetalleWidgetState extends State<TruequeDetalleWidget> {
  String layout = 'list';
  ...
  _initialConfiguration() {
    for (int i = 0; i < widget.infoTrueques!.length; i++) {
      widget.infoTrueques![i].detalleTrueque =
          widget.infoTrueques![i].prodSerTruequeTrues![0];
    }
  }
          ...
          Offstage(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                return TruequeListaItemWidget(
                  heroTag: 'trueques_list',
