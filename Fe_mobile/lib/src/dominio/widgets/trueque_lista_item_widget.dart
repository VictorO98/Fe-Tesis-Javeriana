...
class TruequeListaItemWidget extends StatefulWidget {
  String? heroTag;
  InfoTruequesModel? trueque;
  VoidCallback? onDismissed;

  TruequeListaItemWidget(
      {Key? key, this.heroTag, this.trueque, this.onDismissed})
      : super(key: key);

  @override
  _TruequeListaItemWidgetState createState() => _TruequeListaItemWidgetState();
}

class _TruequeListaItemWidgetState extends State<TruequeListaItemWidget> {
  ...
  _initialConfiguration() async {
    var productoComprador =
        await _contenidoProvider.getPublicacionesPorIdPublicacion(widget
            .trueque!.detalleTrueque!.idproductoserviciocomprador
            .toString());
    var productoVendedor =
        await _contenidoProvider.getPublicacionesPorIdPublicacion(widget
            .trueque!.detalleTrueque!.idproductoserviciovendedor
            .toString());
                              ...
                              Chip(
                                ...
                                shape: StadiumBorder(
                                    side: BorderSide(
                                        color: Theme.of(context).focusColor)),
                                label: Text(
                                  'x ${widget.trueque!.detalleTrueque!.cantidadcomprador}',
                                  style: TextStyle(
                                      color: Theme.of(context).focusColor),
                                ),
                              ),
