...
class ResultadoBusquedaWidget extends StatefulWidget {
  String? heroTag;
  ProductoServicioModel? product;
  VoidCallback? onDismissed;

  ResultadoBusquedaWidget(
      {Key? key, this.heroTag, this.product, this.onDismissed})
      : super(key: key);

  @override
  _ResultadoBusquedaWidgetWidgetState createState() =>
      _ResultadoBusquedaWidgetWidgetState();
}

class _ResultadoBusquedaWidgetWidgetState
    extends State<ResultadoBusquedaWidget> {
  @override
