...
class ConversationsList {
  ...
  ConversationsList() {
    this._conversations = [
      ...
      new Conversation(
          ...
          [
            new Chat(
                ...
                '32min ago',
                new User.basic(
                    'Carol R. Hansen', 'img/user2.jpg', UserState.available)),
            new Chat(
      ...
      new Conversation(
          ...
          [
            new Chat(
                ...
                '1day ago',
                new User.basic('Douglas M. Kirkpatrick', 'img/user2.jpg',
                    UserState.available)),
      ...
      new Conversation(
          new User.basic(
              'John R. Whipple', 'img/user2.jpg', UserState.available),
          [
            new Chat(
      ...
      new Conversation(
          ...
          [
            new Chat(
                ...
                '31min ago',
                new User.basic('Jordan P. Jeffries', 'img/user2.jpg',
                    UserState.available)),
            ...
            new Chat(
                ...
                '43min ago',
                new User.basic(
                    'Jordan P. Jeffries', 'img/user2.jpg', UserState.available))
          ],
          false),
      new Conversation(
          new User.basic(
          ...
          [
            new Chat(
                ...
                '45min ago',
                new User.basic(
                    'Michele J. Dunn', 'img/user2.jpg', UserState.available)),
          ...
          false),
      new Conversation(
          new User.basic('Regina R. Risner', 'img/user2.jpg', UserState.away),
          [
            new Chat(
                'Can scroll in any direction.  ',
                '33min ago',
                new User.basic(
                    'Regina R. Risner', 'img/user2.jpg', UserState.available)),
            new Chat('Supports overlapping (AppBars for example). ',
      ...
      new Conversation(
          ...
          [
            new Chat(
                ...
                '33min ago',
                new User.basic(
                    'Patrick B. Scott', 'img/user2.jpg', UserState.available)),
            new Chat(
